#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generates the comprehensive lighting physics book for the image generation system."""

import pathlib

OUT = pathlib.Path(r"C:/Users/Zombo/Desktop/Antigrav/agentmain_digidesk/agent-main/z/kepgeneralas/server/lighting_physics_book.md")

BOOK = r"""# FÉNY ÉS ÁRNYÉK — Teljes Referenciakézikönyv AI Termékgeneráláshoz
...
*Kézikönyv verziója: 2026-07-01 (v1.0)*
...
lines = BOOK.count("\n")
print(f"Book written: {len(BOOK)} chars, {lines} lines, to: {OUT}")
