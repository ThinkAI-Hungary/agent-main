...
const faqs = [
  ...
  { q: 'Hogyan adok hozzá új csapattagot?', a: 'A <b>Beállítások → Csapat</b> fülön kattints a <b>+ Új tag hozzáadása</b> gombra. Add meg a nevet, email címet, jelszót és válaszd ki a szerepkört (admin/manager/member).' },
  { q: 'Mi a különbség az Admin, Manager és Member között?', a: '<b>Admin</b>: Teljes hozzáférés minden funkcióhoz, beleértve az AI beállításokat és automatizációkat. <b>Manager</b>: Üzleti áttekintés, csapattagok (member) kezelése, de technikai beállítások nélkül. <b>Member</b>: Saját dashboard, ügyfelek és naptár.' },
