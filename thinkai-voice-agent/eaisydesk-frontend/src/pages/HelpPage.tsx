...
const faqs = [
  ...
  { q: 'Hogyan indítok email kampányt?', a: 'A <b>Kimenő kommunikáció → Kampányok</b> menüben kattints az <b>Új kampány</b> gombra. Add meg a kampány nevét, válaszd ki a célcsoportot, írd meg a sablont, és ütemezd a küldést.' },
  { q: 'Hogyan adok hozzá új csapattagot?', a: 'A <b>Beállítások → Csapat</b> fülön kattints a <b>+ Új tag hozzáadása</b> gombra. Add meg a nevet, email címet, jelszót és válaszd ki a szerepkört (admin/manager/munkatárs).' },
  { q: 'Mi a különbség az Admin, Manager és Munkatárs között?', a: '<b>Admin</b>: Teljes hozzáférés minden funkcióhoz, beleértve az AI beállításokat és automatizációkat. <b>Manager</b>: Üzleti áttekintés, csapattagok (munkatárs) kezelése, de technikai beállítások nélkül. <b>Munkatárs</b>: Saját dashboard, ügyfelek és naptár.' },
