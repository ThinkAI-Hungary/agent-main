...
export default function ZomboCampaignPage() {
  ...
  // Dummy creatives list (required by CampaignCreator prop types)
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', fontFamily: "'Inter','Outfit',sans-serif" }}>
      ...
      <div className="zombo-page-header" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 32, height: 32, borderRadius: 10, background: 'linear-gradient(135deg,#eab308,#db2777)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16 }}>
            📢
          </div>
          <div>
            <div style={{ fontSize: 15, fontWeight: 800 }}>AI Kampányok és Paid Hirdetések</div>
            <div style={{ fontSize: 10, color: 'var(--text-muted)' }}>/admin/marketing/zombo/campaign</div>
          </div>
        </div>
      </div>
