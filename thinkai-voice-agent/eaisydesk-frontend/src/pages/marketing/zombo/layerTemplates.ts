...
export function buildLayerTemplates(
  ...
  // Helper: if contrastTextColor is given, replace white fills on text layers
  const textColor = (defaultColor: string) => {
    if (!contrastTextColor) return defaultColor;
    // Only override pure white text layers — leave accent/brand colors as-is
    if (defaultColor === '#ffffff' || defaultColor === '#fff' || defaultColor === 'white') {
  ...
  return [
    // ─────────── 1 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Fedezd fel\na legjobb\nTermékeinket', x: 60, y: 800, width: 960, fontSize: 112, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, textShadow: '0 4px 24px rgba(0,0,0,0.5)', lineHeight: 1.0 },
    ...
    // ─────────── 2 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Prémium\nTermék', x: 60, y: 880, width: 700, fontSize: 110, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, textShadow: '0 4px 20px rgba(0,0,0,0.6)', lineHeight: 1.1 },
    ...
    // ─────────── 3 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `${primary}dd`, opacity: 0.6 },
        { type: 'figure', subType: 'circle', x: 190, y: 280, width: 700, height: 700, fill: accent, opacity: 0.12 },
        { type: 'text', text: '50%', x: 60, y: 380, width: 960, fontSize: 300, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
    ...
    // ─────────── 4 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 820, width: 1080, height: 530, fill: '#ffffff', opacity: 0.6 },
        ...
        { type: 'text', text: 'Tovább', x: 868, y: 1244, width: 144, fontSize: 28, fontFamily: font, fontWeight: '700', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
      ],
    },
    // ─────────── 5 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: 'rgba(5,3,12,0.72)', opacity: 0.6 },
        ...
        { type: 'text', text: 'Időtlen\nElegancia', x: 100, y: 450, width: 880, fontSize: 130, fontFamily: 'Playfair Display', fontWeight: '700', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.1 },
    ...
    // ─────────── 6 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Forradalmi termék\namelyet megvártal', x: 60, y: 880, width: 960, fontSize: 72, fontFamily: font, fontWeight: '800', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.2 },
    ...
    // ─────────── 7 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Tedd különlegessé\na napod', x: 60, y: 315, width: 960, fontSize: 120, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, textShadow: '0 8px 32px rgba(0,0,0,0.5)', lineHeight: 1.0 },
    ...
    // ─────────── 8 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `${primary}e8`, opacity: 0.6 },
        ...
        { type: 'text', text: 'Fantasztikus termék!\nTeljesen elégedett vagyok,\nmindenképpen ajánlom.', x: 100, y: 490, width: 880, fontSize: 54, fontFamily: 'Playfair Display', fontWeight: '400', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.5 },
        { type: 'figure', subType: 'rect', x: 440, y: 990, width: 200, height: 2, fill: accent, opacity: 0.55 },
        { type: 'text', text: 'Kovács Anna', x: 100, y: 1030, width: 880, fontSize: 36, fontFamily: font, fontWeight: '700', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
    ...
    // ─────────── 9 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'BRAND NAME', x: 60, y: 60, width: 700, fontSize: 40, fontFamily: font, fontWeight: '800', align: 'left', fill: textColor('#ffffff'), opacity: 1, textShadow: '0 2px 12px rgba(0,0,0,0.6)' },
    ...
    // ─────────── 10 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: '^', x: 490, y: 1090, width: 100, fontSize: 72, fontFamily: font, fontWeight: '300', align: 'center', fill: textColor('#ffffff'), opacity: 0.85 },
        { type: 'text', text: 'SWIPE UP', x: 290, y: 1190, width: 500, fontSize: 38, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
    ...
    // ─────────── 11 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `linear-gradient(160deg, ${primary} 0%, #0f0f1a 100%)`, opacity: 0.6 },
        ...
        { type: 'text', text: '03', x: 100, y: 380, width: 200, fontSize: 160, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        { type: 'text', text: 'NAP', x: 100, y: 560, width: 200, fontSize: 24, fontFamily: font, fontWeight: '700', align: 'center', fill: accent, opacity: 1 },
        { type: 'text', text: '14', x: 340, y: 380, width: 200, fontSize: 160, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        { type: 'text', text: 'ÓRA', x: 340, y: 560, width: 200, fontSize: 24, fontFamily: font, fontWeight: '700', align: 'center', fill: accent, opacity: 1 },
        { type: 'text', text: '22', x: 580, y: 380, width: 200, fontSize: 160, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        { type: 'text', text: 'PERC', x: 580, y: 560, width: 200, fontSize: 24, fontFamily: font, fontWeight: '700', align: 'center', fill: accent, opacity: 1 },
        { type: 'text', text: '07', x: 820, y: 380, width: 200, fontSize: 160, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        ...
        { type: 'text', text: 'Nagy termékbevezetés', x: 60, y: 680, width: 960, fontSize: 80, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.1 },
    ...
    // ─────────── 12 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'KÜLÖNLEGES AJÁNLAT', x: 60, y: 800, width: 960, fontSize: 28, fontFamily: font, fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 0.5 },
        { type: 'text', text: 'Fedezd fel az új kollekciónkat és válassz a legújabb termékek közül.', x: 60, y: 860, width: 800, fontSize: 40, fontFamily: font, fontWeight: '400', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.4 },
    ...
    // ─────────── 13 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `${primary}f0`, opacity: 0.6 },
        ...
        { type: 'text', text: 'NAGY\nKIADÁS', x: 100, y: 430, width: 880, fontSize: 130, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
    ...
    // ─────────── 14 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 800, width: 1080, height: 550, fill: '#fefce8', opacity: 0.6 },
    ...
    // ─────────── 15 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'NO', x: 60, y: 200, width: 960, fontSize: 280, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 0.08, lineHeight: 1.0 },
        { type: 'text', text: 'PAIN', x: 60, y: 450, width: 960, fontSize: 280, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 0.08, lineHeight: 1.0 },
        { type: 'text', text: 'NO GAIN.', x: 60, y: 300, width: 960, fontSize: 120, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0, textShadow: '0 4px 20px rgba(0,0,0,0.8)' },
    ...
    // ─────────── 16 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'SS25', x: 80, y: 100, width: 200, fontSize: 32, fontFamily: font, fontWeight: '800', align: 'left', fill: textColor('#ffffff'), opacity: 0.7 },
        { type: 'text', text: 'COLLECTION', x: 80, y: 140, width: 600, fontSize: 24, fontFamily: font, fontWeight: '400', align: 'left', fill: textColor('#ffffff'), opacity: 0.5 },
        ...
        { type: 'text', text: 'TAVASZI\nKOLLEKCIÓ', x: 80, y: 960, width: 800, fontSize: 100, fontFamily: 'Playfair Display', fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0, textShadow: '0 4px 24px rgba(0,0,0,0.5)' },
    ...
    // ─────────── 17 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 900, width: 1080, height: 450, fill: '#0f172a', opacity: 0.6 },
        ...
        { type: 'text', text: 'Luxus Penthouse\nBudapest, V. ker.', x: 60, y: 1010, width: 800, fontSize: 64, fontFamily: 'Playfair Display', fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.1 },
    ...
    // ─────────── 18 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `linear-gradient(145deg, #0a0010 0%, ${primary}cc 50%, #0a0010 100%)`, opacity: 0.6 },
        ...
        { type: 'text', text: 'MOST\nERHETŐ EL', x: 60, y: 950, width: 960, fontSize: 96, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0, textShadow: '0 0 40px rgba(139,92,246,0.5)' },
    ...
    // ─────────── 19 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `${primary}ee`, opacity: 0.6 },
        ...
        { type: 'text', text: 'LIVE', x: 72, y: 76, width: 176, fontSize: 28, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
        { type: 'text', text: 'INGYENES\nWEBINÁR', x: 60, y: 160, width: 960, fontSize: 120, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        { type: 'figure', subType: 'rect', x: 60, y: 450, width: 960, height: 2, fill: 'rgba(255,255,255,0.1)', opacity: 1 },
        { type: 'text', text: 'Hogyan dupláld meg a bevételedet\n6 hónap alatt', x: 60, y: 500, width: 960, fontSize: 54, fontFamily: font, fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.3 },
        ...
        { type: 'text', text: 'Július 28. — 14:00', x: 72, y: 828, width: 456, fontSize: 28, fontFamily: font, fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1 },
    ...
    // ─────────── 20 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'ELŐTTE', x: 40, y: 80, width: 460, fontSize: 56, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 0.7 },
        { type: 'text', text: 'UTÁNA', x: 580, y: 80, width: 460, fontSize: 56, fontFamily: font, fontWeight: '900', align: 'left', fill: accent, opacity: 1 },
        { type: 'text', text: 'VS', x: 440, y: 640, width: 200, fontSize: 100, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
        { type: 'text', text: 'Látnod kell az eredményt', x: 60, y: 1180, width: 960, fontSize: 44, fontFamily: font, fontWeight: '700', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
      ],
    },
    // ─────────── 21 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `linear-gradient(180deg, ${primary} 0%, #0f0820 100%)`, opacity: 0.6 },
        ...
        { type: 'text', text: 'Az alkalmazás\namelyet vártál', x: 60, y: 180, width: 960, fontSize: 100, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.1 },
        ...
        { type: 'text', text: 'TUDJ MEG TÖBBET', x: 372, y: 598, width: 256, fontSize: 24, fontFamily: font, fontWeight: '600', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
      ],
    },
    // ─────────── 22 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Bali,\nIndonézia', x: 60, y: 120, width: 960, fontSize: 140, fontFamily: 'Playfair Display', fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0, textShadow: '0 4px 24px rgba(0,0,0,0.5)' },
        ...
        { type: 'text', text: '7 ÉJ / 8 NAP', x: 60, y: 1100, width: 500, fontSize: 36, fontFamily: font, fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1 },
    ...
    // ─────────── 23 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: '#030303', opacity: 0.6 },
        ...
        { type: 'text', text: 'Valami\nNagy\nKözeleg', x: 60, y: 280, width: 960, fontSize: 150, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
    ...
    // ─────────── 24 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: '#111111', opacity: 0.6 },
        ...
        { type: 'text', text: 'FLASH', x: 40, y: 120, width: 1000, fontSize: 220, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        ...
        { type: 'text', text: 'CSAK MA!', x: 40, y: 600, width: 1000, fontSize: 60, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 0.7 },
        { type: 'text', text: '70%', x: 40, y: 680, width: 600, fontSize: 280, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
        ...
        { type: 'text', text: 'VÁSÁROLJ MOST', x: 52, y: 1130, width: 976, fontSize: 40, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
      ],
    },
    // ─────────── 25 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `${primary}f5`, opacity: 0.6 },
        ...
        { type: 'text', text: '5 TIPP', x: 60, y: 200, width: 960, fontSize: 130, fontFamily: font, fontWeight: '900', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
    ...
    // ─────────── 26 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: `linear-gradient(135deg, ${primary} 0%, #1e1060 100%)`, opacity: 0.6 },
        ...
        { type: 'text', text: 'Prémium Csomagot', x: 60, y: 370, width: 960, fontSize: 80, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
        ...
        { type: 'text', text: '1. Kövesd az oldalt', x: 60, y: 680, width: 960, fontSize: 36, fontFamily: font, fontWeight: '600', align: 'left', fill: textColor('#ffffff'), opacity: 1 },
        { type: 'text', text: '2. Likelj és oszd meg', x: 60, y: 740, width: 960, fontSize: 36, fontFamily: font, fontWeight: '600', align: 'left', fill: textColor('#ffffff'), opacity: 1 },
        { type: 'text', text: '3. Jelölj meg 2 barátot', x: 60, y: 800, width: 960, fontSize: 36, fontFamily: font, fontWeight: '600', align: 'left', fill: textColor('#ffffff'), opacity: 1 },
    ...
    // ─────────── 27 ───────────
    {
      ...
      layers: [
        { type: 'figure', subType: 'rect', x: 0, y: 0, width: 1080, height: 1350, fill: '#f8fafc', opacity: 0.6 },
    ...
    // ─────────── 28 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Nyári\nKollekció', x: 60, y: 800, width: 960, fontSize: 130, fontFamily: 'Playfair Display', fontWeight: '700', align: 'left', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.05, textShadow: '0 4px 24px rgba(0,0,0,0.5)' },
    ...
    // ─────────── 29 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'Iratkozz fel\na hírlevélre', x: 60, y: 350, width: 960, fontSize: 110, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1, lineHeight: 1.0 },
    ...
    // ─────────── 30 ───────────
    {
      ...
      layers: [
        ...
        { type: 'text', text: 'LEGJOBB VÁLASZTÉKUNK', x: 60, y: 42, width: 960, fontSize: 42, fontFamily: font, fontWeight: '900', align: 'center', fill: textColor('#ffffff'), opacity: 1 },
