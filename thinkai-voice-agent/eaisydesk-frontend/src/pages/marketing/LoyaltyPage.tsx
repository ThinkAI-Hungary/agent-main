  ...
  return (
    <div className="page active">
      <div className="mkt-page-header">
        <div className="mkt-page-header-icon mkt-page-header-icon--loyalty">
      ...
      <div className="mkt-kpi-grid">
        <div className="mkt-kpi-card mkt-kpi-card--amber"><div className="mkt-kpi-label">Összes tag</div><div className="mkt-kpi-value">415</div></div>
        <div className="mkt-kpi-card mkt-kpi-card--green"><div className="mkt-kpi-label">Aktív tagok</div><div className="mkt-kpi-value">312</div></div>
        <div className="mkt-kpi-card mkt-kpi-card--purple"><div className="mkt-kpi-label">Kiadott pontok</div><div className="mkt-kpi-value">84.2K</div></div>
        <div className="mkt-kpi-card mkt-kpi-card--blue"><div className="mkt-kpi-label">Beváltott kedvezmények</div><div className="mkt-kpi-value">67</div></div>
      </div>
      ...
      <div className="mkt-grid-3">
        {tiers.map(t => (
          <div key={t.name} className={`mkt-tier-card ${t.color}`}>
            ...
            <div className="mkt-tier-threshold">{t.threshold}</div>
            <div className="mkt-tier-discount">Kedvezmény: <strong className="mkt-tier-discount-value">{t.discount}</strong></div>
          </div>
        ))}
      </div>
